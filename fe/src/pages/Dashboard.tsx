                ...
                <div className="flex h-screen">
                    <div className={`z-5 h-screen fixed top-0 left-0 bg-white border-r-2 w-64 p-4 md:w-1/3 lg:w-1/4 xl:w-1/5 ${sidebarOpen? 'block' : 'hidden md:block'}`}>
                        ...
                        <div className="flex-1">
                            ...
                            <ul>
                                <li className="mb-8">
                                    <a href="#" className="text-[#26758F] font-bold text-xl flex">
                                ...
                                <li className="mb-8">
                                    <a href="#" className="text-gray-600 hover:text-gray-900 font-bold text-xl flex">
                    ...
                    <div className="flex-1 p-4 w-full mt-14 md:mt-0">
                        <div className="flex mb-4">
                            ...
                            <div className="w-1/3 items-center flex justify-end">
                                ...
                                <img src="https://via.placeholder.com/50" alt="profile" className='ms-4 md:ms-8 lg:ms-12 xl:ms-16 rounded-full h-full' />
                            </div>
                        </div>
                        <img src="Hero.svg" alt="hero" className='w-full' />
                        <h1 className="text-3xl font-bold my-4 text-[#ff0000]">Main Content</h1>
